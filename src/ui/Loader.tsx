  ...
  return (
    <div className="fixed inset-0 z-9999 bg-donezo-bg flex flex-col items-center justify-center">
      <div className="relative mb-8">
        {/* Outer pulsing ring */}
        <div
          className="absolute inset-0 bg-donezo-primary/20 rounded-full animate-ping"
          style={{ animationDuration: "2s" }}
        ></div>

        {/* Inner spinning ring */}
        <div
          className="absolute -inset-2.5 border-4 border-transparent border-t-donezo-primary border-r-donezo-accent rounded-full animate-spin"
      ...
      <div className="text-center">
        <h2 className="text-2xl font-bold text-donezo-text mb-2 flex items-center justify-center min-w-30">
          Donezo
          <span className="text-donezo-primary w-6 text-left">{dots}</span>
        </h2>
